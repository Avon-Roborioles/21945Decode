...
@Configurable
public class BlueGoalRamp12Ball_Out extends AutoBase {
    ...
    public static Pose grabMid = new Pose(31, 58, Math.toRadians(180));
    ...
    public static Pose scoreMid = new Pose(56.5, 85, Math.toRadians(-110));
    ...
    public static Pose scoreClose = new Pose(60, 112, Math.toRadians(270));
    public static Pose scoreCloseCP = new Pose(44.5, 82.5);



    public static Pose grabRampCycle = new Pose(22, 59, Math.toRadians(155));
    public static Pose grabRampCycleCP1 = new Pose(58.5, 88);
    public static Pose grabRampCycleCP2  = new Pose(59, 66.5);
    public static Pose grabRampCycleCP3  = new Pose(64, 60);
    public static Pose scoreRampCycle = new Pose(56.5, 100, Math.toRadians(-110));
    public static Pose scoreRampCycleCp = new Pose(51, 59.5);
