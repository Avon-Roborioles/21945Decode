...
public class BlueGoal9Sorted12Ball_Out extends AutoBase {
    ...
    Pose grabMid = new Pose(23, 65, Math.toRadians(185));
    ...
    Pose grabFarCP3 = new Pose(45, 30);
    Pose scoreFar = new Pose(59, 116, Math.toRadians(270));
