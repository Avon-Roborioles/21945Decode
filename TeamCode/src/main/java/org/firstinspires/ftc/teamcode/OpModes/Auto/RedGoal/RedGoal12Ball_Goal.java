...
public class RedGoal12Ball_Goal extends AutoBase {
    ...
    public static Pose startingPos = new Pose(26.75, 130, Math.toRadians(141)).mirror();
    public static Pose scorePreload = new Pose(54, 114, Math.toRadians(270)).mirror();
    public static Pose toPickUp1 = new Pose(46, 84, Math.toRadians(180)).mirror();
    public static Pose pickUp1 = new Pose(20, 79, Math.toRadians(180)).mirror();
    public static Pose dumpGate = new Pose(19, 79, Math.toRadians(180)).mirror();
    public static Pose toScore1 = new Pose(56, 79, Math.toRadians(270)).mirror();
    public static Pose toPickUp2 = new Pose( 44, 62, Math.toRadians(180)).mirror();
    public static Pose toPickUp2CP = new Pose(57, 58).mirror();
    public static Pose pickUp2 = new Pose(18, 60, Math.toRadians(180)).mirror();
    public static Pose toScore2 = new Pose(56, 78, Math.toRadians(270)).mirror();
    public static Pose toScore2CP = new Pose(51, 61).mirror();
    public static Pose toPickUp3 = new Pose(44,35.5 , Math.toRadians(180)).mirror();
    public static Pose toPickUp3CP = new Pose(50, 33).mirror();
    public static Pose pickUp3 = new Pose(18, 35.5, Math.toRadians(180)).mirror();
    public static Pose toScore3 = new Pose(56,120 , Math.toRadians(270)).mirror();
    public static Pose toScore3CP = new Pose(50, 38).mirror();
    double maxPower = 1;
